...
export default function SingaporeTour() {
  const schemaMarkup = JSON.stringify({
    ...
    "@type": "BlogPosting",
    "@id": "https://krithiktoursandtravels.com/singapore-to-south-india-tour-package/#blogpost",
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://krithiktoursandtravels.com/singapore-to-south-india-tour-package/"
    },
    ...
    "potentialAction": {
      "@type": "ReadAction",
      "target": [
        "https://krithiktoursandtravels.com/singapore-to-south-india-tour-package/"
      ]
    }
  });
      ...
      additionalSchemas={[
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Singapore to South India Tour Package', item: 'https://www.krithiktoursandtravels.com/singapore-to-south-india-tour-package' },
          ],
        },
      ]}
    >
